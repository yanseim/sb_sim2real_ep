...
# use observation in ore frame, work bad!!!!!!!!!!!!
        # goal = [0.03, -0.03, 0.13]
        ...
        # r=R.from_quat(quat)            
        # rot_mat = r.as_matrix()
        # pos_2_ore = -rot_mat.T @ np.reshape(np.array(tvec),(3,1))
        # rot_2_ore = rot_mat.T
        # if (pos_2_ore[1,0]-goal[1]) < 0:
        #     move_y_right = True
        # else:
        #     move_y_right = False # move to left
        # distance_in_x = pos_2_ore[2]-goal[2]
        # print("distance in x", distance_in_x)
        # print("pos_2_ore", pos_2_ore)
        # print("rot_mat",rot_mat)
        # print("move y to right", move_y_right)
    
        # if (-gama_x<=distance_in_x <= gama_x) and (abs(pos_2_ore[1,0]) <= gama_y):
        #     # step forward
        ...
        # elif (-10*gama_x<=distance_in_x <= 10*gama_x) and (abs(pos_2_ore[1,0]) <= 10*gama_y):
        #     print('2222222222222222222')
        #     if (gama_x<distance_in_x < 10*gama_x):
        #         self.move_base_velocity_x(b_vector = 0.4, duration = 1)
        #         print("move in x")
        #         # time.sleep(1)
        #     if (gama_y<abs(pos_2_ore[1,0]) <= 10*gama_y):
        #         #self.move_base_y()
        #         if move_y_right:  
        ...
        # else:
        #     print("333333333333333333orientation is ",rot_2_ore[1][2])
            
        #     vel_cmd = Twist()
        #     vel_cmd.linear.x = 1*(pos_2_ore[2,0]-goal[2])
        #     vel_cmd.linear.y = 2*(pos_2_ore[1,0]-goal[1])
        #     vel_cmd.linear.z = 0.0
        #     vel_cmd.angular.x = 0.0
        #     vel_cmd.angular.y = 0.0
        #     vel_cmd.angular.z =  0.7*(rot_2_ore[1][2])
        #     self.base_move_vel_pub.publish(vel_cmd)
...
# ==================================================================================
        ...
        if (distance_in_x <= gama_x) and (distance_in_y <= gama_y):
            ...
            if (distance_in_x<10*gama_x) and (distance_in_y <= 10*gama_y):
                ...
                if distance_in_y > gama_y:
                    ...
                    if move_y_right:                        
                        ...
                        self.move_base_velocity_y_left(b_vector = 0.4, duration = 1)
                        print("move y to left")
            else:
                print("333333333333333333")
                
                vel_cmd = Twist()
                vel_cmd.linear.x = 1*(distance_in_x)
                vel_cmd.linear.y = -2*(tvec[0] - goal[0])
                vel_cmd.linear.z = 0.0
                vel_cmd.angular.x = 0.0
                vel_cmd.angular.y = 0.0
                vel_cmd.angular.z =  0.7*(rot_mat[0][2])
                self.base_move_vel_pub.publish(vel_cmd)
